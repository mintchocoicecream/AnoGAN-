...
#desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 1000
desc += '-preset-v2-2gpus'; num_gpus = 1; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 10000
...
train = EasyDict(func='util_scripts.anomaly_detection_encoder', run_id='results/000-pgan-mnist_2_0.0-preset-v2-2gpus-fp32', log='anomaly_detection_cv_32_mnist', test_data_folder="datasets/mnist_2_0.0/validation/anomaly"); num_gpus = 1; desc = 'anomaly-detection-' + str(train.run_id)
train1 = EasyDict(func='util_scripts.anomaly_detection_encoder', run_id='results/002-pgan-mnist_2_0.0-preset-v2-2gpus-fp32', log='anomaly_detection_cv_32_mnist', test_data_folder="datasets/mnist_2_0.0/validation/anomaly2"); num_gpus = 1; desc = 'anomaly-detection-' + str(train.run_id)
